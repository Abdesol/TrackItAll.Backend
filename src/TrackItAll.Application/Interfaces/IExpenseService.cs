...
public interface IExpenseService
{
    ...
    /// <param name="date">The date of the expense. If not specified, defaults to the current date.</param>
    ...
    Task<AddExpenseServiceResponseDto> AddExpense(double amount, string description, int categoryId, DateTime date);
    ...
    Task<UpdateExpenseServiceResponseDto> UpdateExpense(string id, double? amount = null, string? description = null, int? categoryId = null,
        DateTime? date = null);
    ...
    Task<DeleteExpenseServiceResponseDto> DeleteExpense(string id);
